...
//Continue for mass calculating {"04/08/25-Cash":4550}    
    "01922362569":{
        ...
        payment             :{"10/10/25-DBBL":2000,"27/10/25-DBBL":1000},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
        running_payable :2320,
        running_paid    :3500,
        running_meal    :25,
        // method 
        preMonth,
    ...
    "01797816501":{
        ...
        payment             :{"10/10/25-Cash":4000,"24/10/25-Cash":500},
        // running month{"04/08/25-Cash":4550}
        stay_cost       :2300,
        garage_cost     :0,
        running_payable :2319,
        running_paid    :4500,
        running_meal    :41,
        // method calling
        preMonth,
    ...
    "01704351658":{
        ...
        payment             :{"13/10/25-Cash":7000},
        // running month
        stay_cost       :2700,
        garage_cost     :0,
        running_payable :4985,
        running_paid    :7000,
        running_meal    :60,
        // method calling
        preMonth,
    ...
    "01581515641":{//01644377150
        ...
        post_payable        :4395,
        previous_paid       :7500,
        previous_dining_cost:3016,
        payment             :{"07/10/25-Cash":2000,"12/10/24-Cash":3000,"17/10/25-Cash":500,"22/10/25-Cash":300},
        // running month
        stay_cost       :3250,
        garage_cost     :0,
        running_payable :4006,
        running_paid    :5800,
        running_meal    :54,
        // method calling
        preMonth,
    ...
    "01537664564":{
        ...
        payment             :{"13/10/25-Cash":7000,"22/10/25-Cash":500},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
        running_payable :4758,
        running_paid    :7500,
        running_meal    :57,
        // method calling
        preMonth,
    ...
    "01909752631":{
        ...
        post_payable        :4600,
        previous_paid       :6720,
        previous_dining_cost:2204,
        payment             :{"06/10/25-Cash":4000,"10/10/25-Cash":500,"20/10/25-Cash":500,"30/10/25-Cash":500},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :3729,
        running_paid    :5500,
        running_meal    :35,
        // method calling
        preMonth,
    ...
    "01934147404":{
        ...
        payment             :{"01/10/24-Cash":5000,"13/10/24-Cash":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4188,
        running_paid    :5500,
        running_meal    :28,
        // method calling
        preMonth,
	...
	"01639523533":{
        ...
        payment             :{"02/10/24-Cash":5000,"16/10/25-Cash":2000},
        // running month {"01/07/24-Cash":500}
        stay_cost       :3500,
        garage_cost     :0,
        running_payable :4637,
        running_paid    :7000,
        running_meal    :26,
        // method calling
        preMonth,
    ...
    "01920056090":{
        ...
        post_payable        :2151,
        previous_paid       :5700,
        previous_dining_cost:2378,
        payment             :{"10/10/25-Cash":2500,"15/10/25-Minus":500,"22/10/25-bKash":1500,"27/10/25-Cash":1500},
        // running month
        stay_cost       :2400,
        garage_cost     :0,
        running_payable :2074,
        running_paid    :6000,
        running_meal    :44,
        // method calling
        preMonth,
	...
	"01821245430":{
        ...
        post_payable        :574,
        previous_paid       :2500,
        previous_dining_cost:3306,
        payment             :{"09/10/25-Cash":1000,"16/10/25-Cash":1000},
        // running month
        stay_cost       :185,
        garage_cost     :0,
        running_payable :1565,
        running_paid    :2000,
        running_meal    :40,
        // method calling
        preMonth,
